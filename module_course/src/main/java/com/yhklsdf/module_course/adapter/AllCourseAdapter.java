...
public class AllCourseAdapter extends RecyclerView.Adapter<AllCourseAdapter.ViewHolder>
    ...
    public AllCourseAdapter(Context context, List<Course> data, OnClickListener clickListener) {
        mContext = context;
        mData = data;
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = mInflater.inflate(R.layout.item_recycler_all_course, viewGroup, false);
